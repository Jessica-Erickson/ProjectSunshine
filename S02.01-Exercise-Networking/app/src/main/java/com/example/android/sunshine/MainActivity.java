...
public class MainActivity extends AppCompatActivity {
    ...
    private void loadWeatherData() {
        URL fetchWeatherUrl = NetworkUtils.buildUrl(new SunshinePreferences().getPreferredWeatherLocation());
        new FetchWeatherTask().execute(fetchWeatherUrl);
    }
    ...
    private class FetchWeatherTask extends AsyncTask<URL, Void, String> {
        ...
        protected String doInBackground(URL... urls) {
            ...
            try {
                fetchWeatherResults = NetworkUtils.getResponseFromHttpUrl(weatherUrl);
            } catch (IOException e) {
                e.printStackTrace();
            }
        ...
        @Override
        protected void onPostExecute(String fetchWeatherResults) {
            if (fetchWeatherResults != null && !fetchWeatherResults.equals("")) {
                mWeatherTextView.setText(fetchWeatherResults);
            }
        }
    }
}